...
const ScoreMeter: React.FC<Props> = ({popStrokeDashoffset, popIndex}) => {
    return (
        <>
        <svg id='popularityMeter' className='absolute -top-4 -left-4' width="100" height="100" viewBox="0 0 100 100">
            <circle className='popularityMeter stroke-green-400' r="15" cx="50%" cy="49%" fill="rgba(0,0,0,0.4)" strokeWidth='4'  strokeDasharray='94' strokeDashoffset={popStrokeDashoffset}/>
