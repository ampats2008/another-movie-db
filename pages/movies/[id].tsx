...
const Movie: NextPage<Props> = ({content}) => {
    ...
    return (<>
        ...
        <Head>
            <title>AMDb | {content.title} ({releaseDate.getFullYear()})</title>
...
export async function getServerSideProps(context:any) {
    ...
    if (res2.status !== 404 && data2.results.length !== 0) {
        ...
        const maturityRatings : { results: [{ iso_3166_1: string, release_dates: [{certification:string}] }], id: number } = data2;
