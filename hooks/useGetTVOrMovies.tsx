...
function useGetTVOrMovies({ mediaType, pageIndex, sortBy, fallbackData }: Args) {
  ...
  const apiURL = `https://api.themoviedb.org/3/discover/${mediaType}?api_key=${API_KEY}&language=en-US&sort_by=${sortBy}&include_adult=false&include_video=false&page=${pageIndex}&with_watch_monetization_types=flatrate`
  //@ts-ignore
